        ...
        protected virtual void HandleTransforming()
        {
            ...
            if (MoveVector != Vector3.zero)
            {
                ...
                if (!Sprint){
                    ...
                    animator.SetFloat("AnimationSpeed", Mathf.Lerp(ActiveSpeed, (BaseSpeed * 99), delta * AccelerationSpeed));
                }
                else{
                    ActiveSpeed = Mathf.Lerp(ActiveSpeed, SprintingSpeed, delta * AccelerationSpeed);
                    animator.SetFloat("AnimationSpeed", Mathf.Lerp(ActiveSpeed, (SprintingSpeed * 99), delta * AccelerationSpeed));
                }
            }
            else
            {
